...
import { Clock, PhoneCall, RefreshCw, Waves, ShieldAlert, Globe } from "lucide-react";
...
export default function Header({
  ...
  return (
    <header className="relative w-full border-b border-[#1E293B] bg-[#0A0F1A] text-slate-100 shadow-lg z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex items-center justify-center w-11 h-11 rounded-xl bg-[#C51D34] border border-[#003893] text-white shadow-md flex-shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block px-2 py-0.5 text-[9px] font-bold tracking-wider uppercase rounded bg-[#003893] text-blue-100 border border-blue-700">
                  DHM & SATELLITE SYNC
                </span>
              </div>
          ...
          {/* Time, Language Switcher & Actions */}
          <div className="flex items-center flex-wrap gap-2.5 justify-between md:justify-end">
            {/* Nepal Standard Time */}
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0F172A] border border-slate-800 text-xs text-slate-300">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0F172A] hover:bg-[#1E293B] border border-slate-800 text-xs font-bold text-white transition-all active:scale-95"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0F172A] hover:bg-[#1E293B] border border-slate-800 text-xs font-medium text-slate-200 transition-all disabled:opacity-50"
        ...
        <div className="mt-3 py-1.5 px-3 rounded-lg bg-[#0F172A] border-l-4 border-[#C51D34] border-t border-r border-b border-slate-800 flex items-center justify-between text-xs text-slate-200 flex-wrap gap-2">
          <div className="flex items-center gap-2">
