...
export default function BayOfBengalTracker({
  ...
  return (
    <div className="relative rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 p-5 shadow-sm dark:shadow-lg overflow-hidden transition-colors">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-4 border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center gap-3">
          <div className="relative flex items-center justify-center w-11 h-11 rounded-xl bg-red-50 dark:bg-[#162035] border border-red-200 dark:border-slate-700 text-[#C51D34] dark:text-[#FF4D6D] flex-shrink-0">
        ...
        <button
          ...
          className="self-start sm:self-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-[#162035] dark:hover:bg-[#1E293B] border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-700 dark:text-slate-200 transition-all"
        >
      ...
      {showExplanation && (
        <div className="my-4 p-4 rounded-xl bg-slate-50 dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-300 space-y-2.5 animate-fadeIn">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-4">
        {/* Central Pressure */}
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs mb-1">
            <span>{t.centralPressure}</span>
            <Gauge className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" />
          </div>
          <div className="text-xl font-black text-slate-900 dark:text-white tracking-tight tabular-nums">
        ...
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-xl font-black text-slate-900 dark:text-white tracking-tight tabular-nums">
            ...
            <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">km/h</span>
          </div>
          <span className="text-[10px] text-cyan-600 dark:text-cyan-300 font-semibold mt-1">
            {t.galeInBay}
          </span>
        </div>
        ...
        {/* Distance to Nepal */}
        <div className="p-3 rounded-xl bg-red-50/50 dark:bg-[#0A0F1A] border border-red-200 dark:border-[#C51D34]/40 flex flex-col justify-between">
          <div className="flex items-center justify-between text-red-600 dark:text-red-200 text-xs mb-1">
            <span>{t.distToNepal}</span>
            <AlertOctagon className="w-3.5 h-3.5 text-[#C51D34] dark:text-[#FF4D6D]" />
          </div>
          <div className="text-xl font-black text-[#C51D34] dark:text-[#FF4D6D] tracking-tight tabular-nums">
            ~{telemetry.distanceToNepalBorderKm}{" "}
            <span className="text-xs font-semibold text-slate-700 dark:text-white">km</span>
          </div>
          <span className="text-[10px] text-red-600 dark:text-red-300 font-semibold mt-1">
            {t.toKoshiBorder}
          </span>
        </div>
        ...
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
          ...
          <span className="text-[10px] text-[#C51D34] dark:text-[#FF4D6D] font-bold mt-1 uppercase">
            {t.heavyPlume}
          </span>
        </div>
        ...
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
          ...
          <button
            ...
            className="text-[10px] text-blue-600 dark:text-cyan-400 font-bold hover:underline text-left mt-1"
          >
            {t.focusMap}
          </button>
        </div>
      ...
      <div className="mt-4 p-3.5 rounded-xl bg-blue-50/60 dark:bg-[#0A0F1A] border border-blue-200 dark:border-slate-800 flex items-start gap-3">
